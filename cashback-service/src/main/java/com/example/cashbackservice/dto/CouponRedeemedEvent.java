...
public class CouponRedeemedEvent implements Serializable {
    ...
    public CouponRedeemedEvent(Long redemptionId, Long couponId, Long merchantId, Long customerId, BigDecimal purchaseAmount, BigDecimal discountAmount, BigDecimal cashbackPercentage, LocalDateTime redeemedAt) {
        this(redemptionId, couponId, merchantId, customerId, purchaseAmount, discountAmount, cashbackPercentage, redeemedAt, 10);
    }

    public CouponRedeemedEvent(Long redemptionId, Long couponId, Long merchantId, Long customerId, BigDecimal purchaseAmount, BigDecimal discountAmount, BigDecimal cashbackPercentage, LocalDateTime redeemedAt, Integer pointsEarned) {
        ...
        this.pointsEarned = pointsEarned != null ? pointsEarned : 10;
    }
